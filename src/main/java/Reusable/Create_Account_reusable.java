...
public class Create_Account_reusable {

	
	@Test
	public WebDriver createaccount(WebDriver testdriver) throws IOException, InterruptedException
	//
	{
		//testdriver=null;
		for(int i=1;i<3;i++)
...
//UserName and Password	creation
		...
		crea.Username().sendKeys(i+"prod552017");
